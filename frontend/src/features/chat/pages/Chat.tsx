		...
		<div>
			...
			<div className="bg-slate-100 px-4 py-3 rounded-2xl mt-3 border border-slate-200">
				<form className="flex items-center gap-3">
					<input
						className="bg-white w-full py-2.5 px-4 rounded-lg border border-slate-200 focus:outline-slate-400"
						type="text"
						placeholder="Type your message here..."
						autoComplete="false"
					/>
					<Button variant="indigo" icon={Send} iconSize={18} className="py-3">
						Send
					</Button>

...
const ChatManager = () => {
	return (
		<div className="">
			{/* Chat messages */}
			<div className="bg-slate-100 rounded-2xl p-5 h-[70vh] overflow-y-auto flex flex-col gap-10">
				{Array(10).fill(0).map(() => {
					return <>
						<ChatMessage
							author="Aanya Paul"
			...
			<div className="bg-slate-100 p-5 rounded-2xl mt-3 border border-slate-200">
